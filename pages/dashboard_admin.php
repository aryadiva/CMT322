                ...
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <?php
                        ...
                        $sql="SELECT clientName FROM client_case";
        ...
        <div class="col-lg-6 mb-lg-0 mb-4">
          <div class="card z-index-2">
            <div class="card-body pb-0">
              <h6> Case Resolved </h6>
              <!-- <p class="text-sm ms-2"> (<span class="font-weight-bolder">+5%</span>) than last month </p> -->
              <div class="bg-gradient-dark border-radius-lg py-2 mb-3">
                <div class="chart">
            ...
            <div class="card-body ">
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  ...
                  <?php 
                  $count=0;
                  $sql = "SELECT * FROM client_case ORDER BY date_created DESC";
                  $result = mysqli_query($conn, $sql);
    ...
    new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderSkipped: false,
          backgroundColor: "#fff",
          data: [25, 20, 15, 20, 35, 50, 15, 17, 10, 15, 12, 20],
          maxBarThickness: 6
        }, ],
      },
      options: {
