              ...
              <table class="table align-items-center mb-0 ">
                ...
                <tbody>
                  <form action="../assets/php-scripts/add_appointment.php" method="post">
                    <tr>
                      <td class="text-center"><input type="text" name="caseName" id="caseName" required></td>
                      <td class="text-center"><input type="text" name="clientName" id="clientName" required></td>
                      <td class="text-center"><input type="text" name="clientEmail" id="clientEmail" required></td>
                      <td class="text-center"><input type="text" name="staff" id="staff" required></td>
                      <td class="text-center"><input type="date" name="date" id="date" required></td>
                    ...
                    <?php 
                      if (mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)){
                          ...
                          <td> <div class='text-center'>".$row["clientEmail"]."</div> </td>
                          <td> <div class='text-center'>".$row["staff"]."</div> </td>
                          <td> <div class='text-center'>".$row["date"]."</div> </td>
                          <td class='text-center text-secondary text-xs'> <a href='../assets/php-scripts/edit_appointment.php?id={$row['appointmentID']}'>edit</a> 
