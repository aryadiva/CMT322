          ...
          <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-1">
              <table class="table align-items-center mb-0 ">
                ...
                <tbody>
                  <form id ="editCaseForm" action="update_case.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
                    <tr>
                      <td class="text-center"><input type="text" name="case_name" id="caseName" value="<?php echo($row['caseName']) ?>" required></td>
                      <td class="text-center"><input type="text" name="case_type" id="caseType" value="<?php echo($row['caseType']) ?>" required></td>
                      <td class="text-center"><input type="text" name="client_name" id="clientName" value="<?php echo($row['clientName']) ?>" required></td>
                      <td class="text-center"><input type="text" name="client_email" id="clientEmail" value="<?php echo($row['client_email']) ?>" required></td>
                      <td class="text-center"><input type="text" name="staff" id="staff" value="<?php echo($row['staff']) ?>" required></td>
                      <td class="text-center"><input type="text" name="judge" id="judge" value="<?php echo($row['judge']) ?>" required></td>
                      ...
                      <td class="text-center"><input type="file" name="doc_name" id="doc_name" value="<?php echo($row['doc_name']) ?>" required></td>
